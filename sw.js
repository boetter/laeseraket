const CACHE = 'laeseraket-shell-v3';
const SHELL = ['/', '/index.html', '/styles.css', '/app.js', '/manifest.webmanifest', '/icons/icon.svg', '/src/config.js', '/src/legacy.js', '/src/state.js', '/src/sync.js'];
